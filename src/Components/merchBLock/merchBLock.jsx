    ...
    <div id="merch" className="merchBLock">
      <div className="conteiner">
        <div className="merchBlockColumn">
          <div ref={titleRef} className="merchBLockTitle mainTitle">
            Поиграли, теперь можно закупиться{" "}
            <span className="pinkText">мерчом</span> или...
          </div>
            ...
            <div className="merchBLockContentColumn">
              <div className="merchBLockContentRow">
                ...
                <div className="merchBLockContentImg cap">
                  <a
                    href="https://www.youtube.com/watch?v=4aAg7gHpfMo&ab_channel=whatever"
                    target="_blank"
                    rel="noreferrer"
                    className="playVideo hoverAnim"
                  >
                    Обзор
                  </a>
                  <img src={cap} alt="cap" />
      ...
      <div className="merchBlockRibbon">
        <div className="ribbonBlockLine">
          <span className="blockLineItem"></span>
          <span className="blockLineItem"></span>
          <span className="blockLineItem"></span>
          <span className="blockLineItem"></span>
          <span className="blockLineItem"></span>
        ...
        <div className="text">
          <span>not&nbsp;sale&nbsp;</span> <span>not&nbsp;sale&nbsp;</span>
          <span>not&nbsp;sale&nbsp;</span>
          <span>not&nbsp;sale&nbsp;</span>
          <span>not&nbsp;sale&nbsp;</span>
          <span>not&nbsp;sale&nbsp;</span>
